...
include_once("cookbook/AMmathjax.php");

##  $WikiTitle is the name that appears in the browser's title bar.
$WikiTitle = 'Journées Graphes et Algorithmes 2019 (JGA 2019)';
$WikiTag = '13-15 Novembre 2019, Bruxelles, Belgique.';

##  $ScriptUrl is your preferred URL for accessing wiki pages
##  $PubDirUrl is the URL for the pub directory.
$ScriptUrl = 'http://di.ulb.ac.be/algo/jga2019';
# $PubDirUrl = 'http://di.ulb.ac.be/algo/jga2019';
...
$DefaultPasswords['admin'] = crypt('picasso');
$DefaultPasswords['edit'] = crypt('picasso');
